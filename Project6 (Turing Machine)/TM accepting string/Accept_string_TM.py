...
try:
    ...
    if errorCode == 1:
        ...
        for string in inputTM:
            ...
            flag = 1  # folosim o variabila pentru a ști când să oprim validarea unui șir
                ...
                for transition in transitions:  # cautam tranzitia care incepe cu starea curenta si citeste primul simbol situat in dreapta starii curente
                    ...
                    if transition[0] == copyString[position] and transition[2] == copyString[position+1]:
                        if transition[4] == "l":  # capul ar trebui să meargă la stânga
                            ...
                            if position == (len(copyString) - 2):  # dacă am ajuns la pătratul dinaintea celui mai din dreapta pătrat al benzii, adăugăm un simbol gol pe bandă
                                copyString.append("_")
